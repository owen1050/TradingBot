...
class CryptoHistoryAccessor:

    #days - how many days back to search for price
    #returns - 2d array of [dateimte, open, high, low, close, vol, mc]s
    def getDailyForNDays(days, url, driverPath):
